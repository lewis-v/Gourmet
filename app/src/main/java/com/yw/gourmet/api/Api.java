...
public class Api {
    public final static String API_BASE_URL = "http://192.168.0.100:47423";//这里是服务器连接的接口的固定部分 39.108.236.30
    ...
    public Observable<BaseData> SendMessage(List<MultipartBody.Part> parts){
